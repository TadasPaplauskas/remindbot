function App() {
    ...
    self.init = function (dependencies) {
        ...
        patterns = [
            ...
            {
                pattern: '^(list|show|all|show reminders)$',
                callback: reminders.list

            },
            // most specific patterns should go to the top
            {
                pattern: 'Remind(er to |er | me to | me about | me | about | to | ){string} (today|tomorrow|monday|tuesday|wednesday|thursday|friday|saturday|sunday|next monday|next tuesday|next wednesday|next thursday|next friday|next saturday|next sunday|january|february|march|april|may|june|july|august|september|october|november|december)$',
                callback: reminders.remindIncomplete
            },
            {
                pattern: '^Remind(er to |er | me to | me about | me | about | to | ){string} (today|tomorrow|monday|tuesday|wednesday|thursday|friday|saturday|sunday|next monday|next tuesday|next wednesday|next thursday|next friday|next saturday|next sunday|in|after|next|january|february|march|april|may|june|july|august|september|october|november|december) {string}$',
            ...
            {
                pattern: '^(today|tomorrow|monday|tuesday|wednesday|thursday|friday|saturday|sunday|next monday|next tuesday|next wednesday|next thursday|next friday|next saturday|next sunday|january|february|march|april|may|june|july|august|september|october|november|december) {string} at {string}$',
                callback: reminders.dayReminderTime
            },
            {
                pattern: '^{string} (today|tomorrow|monday|tuesday|wednesday|thursday|friday|saturday|sunday|next monday|next tuesday|next wednesday|next thursday|next friday|next saturday|next sunday|in|after|next|at|on|january|february|march|april|may|june|july|august|september|october|november|december) {string}$',
    ...
    self.noMatch = function (text) {
        ...
        if (clarifiedDate) {
            reminders.updateLastOne({ 'sender.id': message.sender.id, completed: false }, { remind_at: clarifiedDate }, function(err, reminder) {
                    if (err) throw err;
