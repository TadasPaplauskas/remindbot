function App() {
    ...
    self.init = function (dependencies) {
        ...
        patterns = [
            ...
            {
                pattern: '^{string} (today|tomorrow|monday|tuesday|wednesday|thursday|friday|saturday|sunday|next monday|next tuesday|next wednesday|next thursday|next friday|next saturday|next sunday|in|after|next|at|on) {string}$',
