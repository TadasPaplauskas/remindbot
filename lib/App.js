function App()
{
    ...
    self.init = function (dependencies)
    {
        ...
        patterns = [
            ...
            {
                pattern: '^Remind(er to |er | me to | me about | me | about | ){string} (today|tomorrow|monday|tuesday|wednesday|thursday|friday|saturday|sunday|next monday|next tuesday|next wednesday|next thursday|next friday|next saturday|next sunday|in|after|next) {string}$',
                callback: reminders.remindSoonWithSeparator
            },
            {
                pattern: '^Remind(er to |er | me to | me about | me | about | ){string} (on|at|in) {string}$',
                callback: reminders.remindOnDateWithSeparator
            },
            {
                pattern: 'Remind(er to |er | me to | me about | me | about | ){string} (today|tomorrow|monday|tuesday|wednesday|thursday|friday|saturday|sunday|next monday|next tuesday|next wednesday|next thursday|next friday|next saturday|next sunday)$',
                callback: reminders.remindIncomplete
            },
            {
                pattern: 'Remind(er to |er | me to | me about | me | about | ){string}$',
                callback: reminders.remindIncomplete
            },
            {
